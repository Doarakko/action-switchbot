...
const switchbot = __importStar(__nccwpck_require__(2889));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const deviceName = core.getInput('deviceName');
            const command = core.getInput('command');
            const sceneName = core.getInput('sceneName');
            ...
            if (deviceName !== '') {
                const deviceId = yield switchbot.getDeviceIdByName(deviceName);
                yield switchbot.commandDevice(deviceId, command);
            }
            else {
                const sceneId = yield switchbot.getSceneIdByName(sceneName);
                yield switchbot.executeScene(sceneId);
            }
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.commandDevice = exports.executeScene = exports.getDeviceIdByName = exports.getSceneIdByName = void 0;
const core = __importStar(__nccwpck_require__(7484));
...
function getSceneIdByName(name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield client.get('scenes');
...
exports.getSceneIdByName = getSceneIdByName;
function getDeviceIdByName(name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield client.get('devices');
...
exports.getDeviceIdByName = getDeviceIdByName;
...
function commandDevice(id, command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
var getProxyForUrl = (__nccwpck_require__(7777)/* .getProxyForUrl */ .T);
var http = __nccwpck_require__(8611);
var https = __nccwpck_require__(5692);
var httpFollow = __nccwpck_require__(5665);
var httpsFollow = __nccwpck_require__(4852);
...
var platform = __nccwpck_require__(5896);
var fromDataURI = __nccwpck_require__(3566);
var stream = __nccwpck_require__(2203);
var estimateDataURLDecodedBytes = __nccwpck_require__(9978);
...
var formDataToJSON = __nccwpck_require__(9019);
/**
...
var toURLEncodedForm = __nccwpck_require__(9712);
var platform = __nccwpck_require__(5896);
var formDataToJSON = __nccwpck_require__(9019);
...
module.exports = __nccwpck_require__(5416);
...
var utils = __nccwpck_require__(9743);
var AxiosURLSearchParams = __nccwpck_require__(9183);
...
var utils = __nccwpck_require__(9743);
var AxiosError = __nccwpck_require__(1914);
var envFormData = __nccwpck_require__(5687);
...
module.exports = __nccwpck_require__(853);
...
module.exports = {
  isNode: true,
  classes: {
    URLSearchParams: __nccwpck_require__(1825),
    FormData: __nccwpck_require__(9042),
...
module.exports = __nccwpck_require__(1573).http;
...
module.exports = __nccwpck_require__(1573).https;
