...
const switchbot = __importStar(__nccwpck_require__(889));
function run() {
...
function getSceneIdByName(name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch(`${BASE_URL}scenes`, {
                headers: getHeaders(),
...
function getDeviceIdByName(name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch(`${BASE_URL}devices`, {
                headers: getHeaders(),
                signal: createTimeoutSignal()
            });
            const data = yield response.json();
...
function executeScene(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield fetch(`${BASE_URL}scenes/${id}/execute`, {
                method: 'POST',
                headers: getHeaders(),
                signal: createTimeoutSignal()
            });
...
function commandDevice(id, command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield fetch(`${BASE_URL}devices/${id}/commands`, {
                method: 'POST',
                headers: getHeaders(),
